...
exports.createProfileEvent =  function (idEvent, profile) {
  ...
  if(profile.length){
    ...
    features.saveProfileEvent(idEvent,[]);
    features.saveProfileEvent(idEvent, normalizedArray);
    // callback(idEvent, normalizedArray);
    return true;
  }else{
    features.saveProfileEvent(idEvent,[]);
    return false;
